...
const cacheName = 'LAWk6LucyRankin-2021-03-16 16:27:13.310461'; // unique value, generated each deploy
const contentToCache = [
  ...
  'nsb/images/192.png',
  'nsb/library/StanfordCryptoLibrary.js',
  'nsb/library/appstudioFunctions.js',
  'nsb/library/shake.js',
  'nsb/library/jquery.xml2json.js',
  'nsb/library/jquery-validation.js',
  'nsb/library/basicFunctions.js',
  'nsb/library/jquery3.js',
  'nsb/library/retina.min.js',
  'nsb/library/GoogleDrive.js',
  'nsb/library/i18n.bundled.js',
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAWk6LucyRankin'.length) === 'LAWk6LucyRankin') {
